...
import com.leftshift.weatherapp.model.Location;
import com.leftshift.weatherapp.model.Weather;
import com.leftshift.weatherapp.model.WeatherForecast;

/**
 * Created by divya jaisawal on 9/5/2015.
 */
public class JSONWeatherParser {
    public static String TAG = "JSONWeatherParser";
    ...
    public static Weather getWeather(String data) throws JSONException {
        ...
        Log.d(TAG, "iconJSON" + (getString("icon", JSONWeather)));
